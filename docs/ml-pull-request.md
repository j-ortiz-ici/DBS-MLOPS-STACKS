...
Opening a pull request will trigger a[workflow](../.github/workflows/diabetes-run-tests.yml) 
...
* [Staging workspace registered model](https://adb-8621072713685549.9.azuredatabricks.net#mlflow/models/staging-diabetes-model)
* [Prod workspace registered model](https://adb-8621072713685549.9.azuredatabricks.net#mlflow/models/prod-diabetes-model)
