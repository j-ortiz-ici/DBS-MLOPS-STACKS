...
Opening a pull request will trigger a[workflow](../.github/workflows/python-start-run-tests.yml) 
...
* [Staging workspace registered model](https://adb-8621072713685549.9.azuredatabricks.net#mlflow/models/staging-python-start-model)
* [Prod workspace registered model](https://adb-8621072713685549.9.azuredatabricks.net#mlflow/models/prod-python-start-model)
