...
```
BDS-MLOps        <- Root directory. Both monorepo and polyrepo are supported.
│
├── python_start       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
