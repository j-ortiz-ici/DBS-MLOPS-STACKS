...
[ML Config](../diabetes/resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore diabetes/resources/README.md
...
Follow the instructions in [diabetes/resources/README.md](../diabetes/resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../diabetes/resources/README.md)  to propose, test, and deploy
