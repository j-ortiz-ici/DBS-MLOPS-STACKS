...
[ML Config](../python_start/resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore python_start/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://adb-8621072713685549.9.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-8621072713685549.9.azuredatabricks.net#setting/accounts). If
...
Follow the instructions in [python-start/resources/README.md](../python_start/resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../python_start/resources/README.md)  to propose, test, and deploy
